...
const Modal = ({ isOpen, onClose, data }) => {
  ...
  return (
    ...
    >
      <div
        className='bg-white p-5 rounded shadow-lg w-[65%] max-h-[85%] overflow-x-scroll'
        ...
        <div className='grid grid-cols-3 gap-x-5 gap-y-10'>
          {data.map((item, index) => (
            ...
            >
              ...
              />
              <button className='white px-[18px] py-[4.5px] rounded-[7px] maxScreenMobile:py-[10px] maxScreenMobile:px-[20px] absolute bottom-[12px] right-[12px]'>
                Add To Cart
              </button>
            </div>
          ))}
